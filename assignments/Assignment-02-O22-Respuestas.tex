...
$ H_o:\beta_0 = 0 $ \text{contra: } $ H_a:\beta_0 \neq 0 $ 
...
\text{Entonces, el valor p } 

$ T_{obs} = \frac{(\rho*\sqrt(5-2))}{\sqrt(1-\rho^2)} $

  \text{con la formula en R } 
$$2*(1-pt(T_{obs}, df = 5-2)) = 0.0751 $$


\text{con concluimos que "hay una relación lineal significativa entre las calificaciones esperadas y la puntuación final del examen" dado que Rechazamos Ho .}
