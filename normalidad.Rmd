...
#### 5.2) Realiza un boxplot para mostrar la distribución de los errores de la regresión
...
#### 5.3) Realiza un qqplot para mostrar la distribución de los errores de la regresión
```{r}
residuo %>% 
...
#### 5.3) Realiza una prueba Jarque-Bera para mostrar la distribución de los errores de la regresión
```{r}
jarque.bera.test(residuo$.pred)
```
Por lo tanto rechazamos que los datos sean normales. 

#### 5.3) Comprueba que cov(errores), var(error), 
